  ...
  if(prod === 'OTROS'){
    ...
    detalle.innerHTML = `
      ...
      <div class="field" style="margin-top:14px;">
        ...
        <input type="text" id="marcaotros-${id}" maxlength="30" placeholder="Ej: Huawei, Noblex, LG, Alcatel, etc.">
      </div>
      <div class="field" style="margin-top:14px;">
        <label class="fld">Ingrese modelo, si corresponde</label>
        <input type="text" id="modelootros-${id}" maxlength="40" placeholder="Escribí el modelo (opcional)...">
      </div>
      <div class="field" style="margin-top:14px;">
  ...
  if(mods){
    ...
    detalle.innerHTML = `
      <div class="field">
        ...
        <input type="text" id="marca-${id}" maxlength="30" placeholder="Ej: Huawei, Noblex, LG, Alcatel, etc.">
      </div>
      <div class="field" style="margin-top:14px;">
  ...
  items.forEach(it=>{
    ...
    if(fam === 'Seguridad' || fam === 'Vidrios'){
      ...
      if(prod === 'OTROS'){
        ...
        const marca = (document.getElementById(`marcaotros-${id}`)?.value || '').trim();
        const modeloTxt = (document.getElementById(`modelootros-${id}`)?.value || '').trim();
        ...
        registros.push({ fecha, tienda, familia: fam, producto: productoFinal, modelo: modeloTxt, cantidad: parseInt(qty) });
